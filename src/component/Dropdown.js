...
//     {/* <input className="dropdown_content" value={selectedOption || "select"} /> */}
   
//       <span className="dropdown_content">{selectedOption || count}</span>
...
//         <li
//           id={i + 1}
//           disabled={props.disable_btn}
//           className="ListItem"
//           style={{ cursor: "pointer" }}
//          value={option.Value}
//           key={i + 1}
//           onClick={(e)=>handletext(e,option.Value)}
//         >
//           {option.Label}
//         </li>
//       ))}
